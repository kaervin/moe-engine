...
#define HMM_SQUARE(x) ((x) * (x))
    ...
    HMM_INLINE hmm_vec2 vec2(float X, float Y)
    {
        hmm_vec2 Result;
    ...
    HMM_INLINE hmm_vec2 vec2i(int X, int Y)
    {
        hmm_vec2 Result;
    ...
    HMM_INLINE hmm_vec3 vec3(float X, float Y, float Z)
    {
        hmm_vec3 Result;
    ...
    HMM_INLINE hmm_vec3 vec3i(int X, int Y, int Z)
    {
        hmm_vec3 Result;
    ...
    HMM_INLINE hmm_vec4 vec4(float X, float Y, float Z, float W)
    {
        hmm_vec4 Result;
    ...
    HMM_INLINE hmm_vec4 vec4i(int X, int Y, int Z, int W)
    {
        hmm_vec4 Result;
    ...
    HMM_INLINE hmm_vec4 vec4v(hmm_vec3 Vector, float W)
    {
        hmm_vec4 Result;
    ...
    HMM_INLINE hmm_vec2 div_v2(hmm_vec2 Left, hmm_vec2 Right)
    {
        hmm_vec2 Result;
    ...
    HMM_INLINE hmm_vec2 div_v2f(hmm_vec2 Left, float Right)
    {
        hmm_vec2 Result;
    ...
    HMM_INLINE hmm_vec3 div_v3(hmm_vec3 Left, hmm_vec3 Right)
    {
        hmm_vec3 Result;
    ...
    HMM_INLINE hmm_vec3 div_v3f(hmm_vec3 Left, float Right)
    {
        hmm_vec3 Result;
    ...
    HMM_INLINE hmm_vec4 div_v4(hmm_vec4 Left, hmm_vec4 Right)
    {
        hmm_vec4 Result;
    ...
    HMM_INLINE hmm_vec4 div_v4f(hmm_vec4 Left, float Right)
    {
        hmm_vec4 Result;
    ...
    HMM_INLINE float dot_v2(hmm_vec2 VecOne, hmm_vec2 VecTwo)
    {
    ...
    HMM_INLINE float dot_v3(hmm_vec3 VecOne, hmm_vec3 VecTwo)
    {
    ...
    HMM_INLINE float dot_v4(hmm_vec4 VecOne, hmm_vec4 VecTwo)
    {
        float Result;
    ...
    HMM_INLINE hmm_vec3 cross(hmm_vec3 VecOne, hmm_vec3 VecTwo)
    {
        hmm_vec3 Result;
    ...
    HMM_INLINE float len_squared_v2(hmm_vec2 A)
    {
    ...
    HMM_INLINE float len_squared_v3(hmm_vec3 A)
    {
    ...
    HMM_INLINE float len_squared_v4(hmm_vec4 A)
    {
    ...
    HMM_INLINE hmm_vec2 normalize_v2(hmm_vec2 A)
    {
        hmm_vec2 Result = {0};
    ...
    HMM_INLINE hmm_vec3 normalize_v3(hmm_vec3 A)
    {
        hmm_vec3 Result = {0};
    ...
    HMM_INLINE hmm_vec4 normalize_v4(hmm_vec4 A)
    {
        hmm_vec4 Result = {0};
    ...
    HMM_INLINE hmm_quaternion quaternion(float X, float Y, float Z, float W)
    {
    ...
    HMM_INLINE hmm_quaternion quaternionV4(hmm_vec4 Vector)
    {
        hmm_quaternion Result;
    ...
    HMM_INLINE hmm_quaternion mul_quat(hmm_quaternion Left, hmm_quaternion Right)
    {
        hmm_quaternion Result;
    ...
    HMM_INLINE hmm_quaternion mul_quatF(hmm_quaternion Left, float Multiplicative)
    {
        hmm_quaternion Result;
    ...
    HMM_EXTERN hmm_quaternion inverse_quat(hmm_quaternion Left);
    
    HMM_INLINE float dot_quat(hmm_quaternion Left, hmm_quaternion Right)
    {
    ...
    HMM_INLINE hmm_quaternion normalize_quat(hmm_quaternion Left)
    {
        hmm_quaternion Result;
    ...
    HMM_EXTERN hmm_mat4 quaternionToMat4(hmm_quaternion Left);
    HMM_EXTERN hmm_quaternion quaternionFromAxisAngle(hmm_vec3 Axis, float AngleOfRotation);
...
{
    hmm_vec2 Result = normalize_v2(A);    
...
{
    hmm_vec3 Result = normalize_v3(A);
...
{
    hmm_vec4 Result = normalize_v4(A);
...
{
    hmm_quaternion Result = normalize_quat(A);
...
{
    float Result = dot_v2(VecOne, VecTwo);
...
{
    float Result = dot_v3(VecOne, VecTwo);
...
{
    float Result = dot_v4(VecOne, VecTwo);
...
{
    float Result = dot_quat(QuatOne, QuatTwo);
...
{
    hmm_quaternion Result = mul_quat(Left, Right);
...
{
    hmm_quaternion Result = mul_quatF(Left, Right);
...
{
    hmm_vec2 Result = div_v2(Left, Right);
...
{
    hmm_vec2 Result = div_v2f(Left, Right);
...
{
    hmm_vec3 Result = div_v3(Left, Right);
...
{
    hmm_vec3 Result = div_v3f(Left, Right);
...
{
    hmm_vec4 Result = div_v4(Left, Right);
...
{
    hmm_vec4 Result = div_v4f(Left, Right);
...
{
    hmm_quaternion Result = mul_quatF(Right, Left);
...
hmm_mat4 HMM_LookAt(hmm_vec3 Eye, hmm_vec3 Center, hmm_vec3 Up)
{
    ...
    hmm_vec3 F = normalize_v3(HMM_SubtractVec3(Center, Eye));
    hmm_vec3 S = normalize_v3(cross(F, Up));
    hmm_vec3 U = cross(S, F);
...
hmm_quaternion inverse_quat(hmm_quaternion Left)
{
...
hmm_mat4 quaternionToMat4(hmm_quaternion Left)
{
    hmm_mat4 Result;
    Result = HMM_Mat4d(1);
    
    hmm_quaternion NormalizedQuaternion = normalize_quat(Left);
...
hmm_quaternion quaternionFromAxisAngle(hmm_vec3 Axis, float AngleOfRotation)
{
    hmm_quaternion Result;
